...
export namespace ProductImagesService {
    export const baseUrl = 'Souqcom/ProductImages';
    ...
    export const Methods = {
        Create: "Souqcom/ProductImages/Create",
        Update: "Souqcom/ProductImages/Update",
        Delete: "Souqcom/ProductImages/Delete",
        Retrieve: "Souqcom/ProductImages/Retrieve",
        List: "Souqcom/ProductImages/List"
    } as const;
