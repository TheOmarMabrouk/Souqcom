...
namespace texts {
    export declare namespace Db {
        ...
        namespace Souqcom {
            export function asKey(): typeof Souqcom;
            export function asTry(): typeof Souqcom;
            namespace Cart {
                export function asKey(): typeof Cart;
                export function asTry(): typeof Cart;
                export const EntityPlural: string;
                export const EntitySingular: string;
            ...
            namespace ProductImages {
                export function asKey(): typeof ProductImages;
                export function asTry(): typeof ProductImages;
                export const EntityPlural: string;
                export const EntitySingular: string;
                export const Id: string;
            ...
            namespace Products {
                ...
                export const Discription: string;
                export const EntityPlural: string;
                export const EntitySingular: string;
